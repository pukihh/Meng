...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------Armantod'+'KANG-API';
...
router.get('/pantun', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'MannKey') return res.json(loghandler.invalidKey)
          bdyyyy = await fetch('https://raw.githubusercontent.com/Caliph71/txt/main/pantun.txt')
       bdy = await bdyyyy.text()
        splitnix = bdy.split('\n')
...
router.get('/bijak', async (req, res, next) => {
        var apikeyInput = req.query.apikey
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'MannKey') return res.json(loghandler.invalidKey)
          bdyyyy = await fetch('https://raw.githubusercontent.com/Caliph71/txt/main/katabijak.txt')
       bdy = await bdyyyy.text()
        splitnix = bdy.split('\n')
...
router.get('/random/loli', async (req, res, next) => {
	...
	if(apikeyInput != 'MannKey') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-zahirrr.herokuapp.com/api/random/wallpaper?genre=loli`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/waifu', async (req, res, next) => {
	...
	if(apikeyInput != 'MannKey') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-zahirrr.herokuapp.com/api/random/wallpaper?genre=waifu`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/nekonime', async (req, res, next) => {
	...
	if(apikeyInput != 'MannKey') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-zahirrr.herokuapp.com/api/random/wallpaper?genre=nekonime`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
